...
public enum Code {
    ...
    INVALID_PHONE_NUMBER(1011, "잘못된 전화번호 형식입니다", HttpStatus.BAD_REQUEST),
    INVALID_GEOPOINT(1012, "유효하지 않은 위도/경도 값입니다.", HttpStatus.BAD_REQUEST),
    INVALID_ADDRESS(1013, "주소값은 비어있을 수 없습니다.", HttpStatus.BAD_REQUEST);
